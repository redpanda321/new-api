...
<p align="center">
  <a href="https://raw.githubusercontent.com/redpanda321/hanggent-api/main/LICENSE">
    <img src="https://img.shields.io/github/license/redpanda321/hanggent-api?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/redpanda321/hanggent-api/releases/latest">
    <img src="https://img.shields.io/github/v/release/redpanda321/hanggent-api?color=brightgreen&include_prereleases" alt="version">
  </a><!--
...
<p align="center">
  <strong>Merci à <a href="https://www.jetbrains.com/?from=Hanggent-API">JetBrains</a> pour avoir fourni une licence de développement open-source gratuite pour ce projet</strong>
</p>
...
### 📖 [Documentation officielle](https://docs.newapi.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/redpanda321/hanggent-api)
...
> [!TIP]
> **Dernière image Docker:** `redpanda321/hanggent-api:latest`
...
| `PYROSCOPE_APP_NAME` | Nom de l'application Pyroscope | `Hanggent-API` |
...
| `HOSTNAME` | Nom d'hôte tagué pour Pyroscope | `Hanggent-API` |
...
2. Recherchez **Hanggent-API** dans le magasin d'applications
...
| [hanggent-api-horizon](https://github.com/redpanda321/hanggent-api-horizon) | Version optimisée haute performance de New API |
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=redpanda321/hanggent-api&type=Date)](https://star-history.com/#redpanda321/hanggent-api&Date)
...
**[Documentation officielle](https://docs.newapi.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/redpanda321/hanggent-api/issues)** • **[Dernière version](https://github.com/redpanda321/hanggent-api/releases)**
